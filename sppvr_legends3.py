...
#ЭзетимибСтат
if (("НЭстатины" and ("20Б" or "20В" or "20Г") and ("25А" or "25Б")) or ("32Б" or "32В" and "23А" and ("25А" or "25Б"))) in y:
    v = 'В дополнение к терапии следует назначить селективный ингибитор абсорбции холестерина (Эзетимиб)'
#ЭзетимибМоно
if ("НРССС" and ("22А" or "22Б" or "22В") and ("25А" or "25Б")) in y:
    v = 'Возможно назначение монотерапии селективным ингибитором абсорбции холестерина (Эзетимиб)'
#НЭЛСТ
if (("НРССС" and ("22З" or "22И" or "22К") and ((not "32Б") and ("32Б" or "32Г" or "32Д" or "32Е"))) or
("УРССС" and ("22З" or "22И" or "22К") and ((not "32Б") and ("32Б" or "32Г" or "32Д" or "32Е"))) or
("ВРССС" and ("22Д" or "22Е" or "22Ж" or "22З" or "22И" or "22К") and ((not "32Б") and ("32Б" or "32Г" or "32Д" or "32Е"))) or
("ОВССС" and ("22В" or "22Г" or "22Д" or "22Е" or "22Ж" or "22З" or "22И" or "22К") and ((not "32Б") and ("32Б" or "32Г" or "32Д" or "32Е")))) in y:
    v = 'Недостаточный эффект от липидснижающей терапии'
#Фибраты
if ("ЛСМТ" and "33Б" and "34Б" and "37Б") in y:
    v = 'Рекомендовано добавление фибратов к проводимой терапии'
